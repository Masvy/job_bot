from aiogram.filters import Command, and_f, or_f, StateFilter
...
from database.admin import number_applicants, applicants_name, \
                           ...
                           number_registered
from database.dialogues import update_admin_id, update_user_id, read_user_id
from states.admin_states import Dialogue
